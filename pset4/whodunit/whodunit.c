...
*  Problem 1:     https://docs.cs50.net/problems/whodunit/whodunit.html
*
* The program reads bmp, change its colours and outputs a new file in which it's clear whodunit.
*/
...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0, biHeight = abs(bi.biHeight); i < biHeight; i++)
    {
        ...
        for (int j = 0; j < bi.biWidth; j++)
        {
            ...
            // if a pixel is not white or red, change it to blue
