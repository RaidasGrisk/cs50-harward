...
*  Problem set 1: https://docs.cs50.net/2017/fall/psets/1/pset1.html
*  Problem 2:     https://docs.cs50.net/problems/cash/cash.html
*
* The code asks user to specify change requared by a customer and outputs minimum number of coins with which said change can be made.
*/
...
int main(void){
  ...
  // return a minimum number of coins to give change
  return quarter_c + dime_c + nickel_c + penny_c;
